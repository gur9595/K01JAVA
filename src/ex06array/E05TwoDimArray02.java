...
public class E05TwoDimArray02 {
	...
	public static void main(String[] args) {
		...
		for(int i=0 ; i<twoArray.length; i++) {
			//가로크기만큼 반복 (배열명[인덱스]를 이용해 각 행의 크기 가져옴)
		...
		showArray(twoArray);
		/*
		 배열의 각요소 값을 전달한 매개변수만큼 증가시킴 여기서는 10만큼을증가
		 */
	...
	/*
	 배열을 출력하는 부분이 중복되기때문에 이런경우 메소드를 
	 생성하여 호출해 주는것이좋다
	 */

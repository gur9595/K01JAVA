...
class Car {
	...
	소유주 : Human 클래스를 기반으로 하는 멤버변수로
		초기화를 위해 이름, 나이, 에너지 세가지의 값이 필요
		클래스를 구성할때 또 더른 객체를 멤버변수로 선언할수있다
	*/
	...
	/*
	 객체의 초기화를 담당하는 메소드로 아래는 
	 항상 같은 값으로만 초기화 된다는 한계를 가지고 있다.
	 */
	void initialize() {
		carModel="람보르기니";
		carYear=2017;
...
public class E03CarMain{
	public static void main(String[] args) {
		...
		//car1.drive(); 
		/*에러발생 
		자동차  소유주를 표현하는 Human객체가 초기화되지않은 상태에서 출력을 시도하여 에러발생
		*/
		...
		//자동차 2 객체 생성: 객체생성후 멤버변수를 직접 접근하여 초기화한다
		Car car2=new Car();
		...
		//세번째 자동차 객체 생성: 매개변수가있는 초기화 매소드를 이용해 초기화

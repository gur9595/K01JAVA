...
class FruitSeller{
	...
	/*
	 ...
	 만약 선언과 초기화를 별도로 처리하면 에러발생(테스트시 초기화되는 1000부분을 제거후 확인해볼것)
	 */
	
	//판매자가 사과를 판매하는 행위를 표현한 맴버메소드
	/*
	 1.금액을 전달받는다
	 2.금액에 해당하는 판매될 사과의 갯수를 구한다
	 3.보유한 재고에서 갯수만큼 차감한다
	 4.판매수입이 증가한다
	 5.구매자에게 판매한사과의 갯수를 반환한다
	 */

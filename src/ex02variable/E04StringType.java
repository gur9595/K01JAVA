...
public class E04StringType {
	...
	public static void main(String[] args) {
		...
		/*
		 String: 참조형 변수로써 기본자료형이 아님
		 문자열을 저장할수있는 데이터타입으로 실제로는 class이다
		 자바에서는 문자열을 표현할때 "으로 감싸면되고,연결할때+기호를 사용
		 */
		int number=99;
		...
		/*
		 String은 클래스이므로 new키워드를 이용해서 인스턴스를 생성한 후 문자열을 참조한다
		 */
		...
		/*\
		 ...
		 단 산술연산의 결과를 출력하고 싶다면 아래와같이 소과로를 이용해서
		 우선순위에 대한 변화를 주면된다.
		 */

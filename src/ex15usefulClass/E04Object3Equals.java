...
class MyClass{
	...
	/*
	toString() :실제 저장된 데이턱 반환되도록 Object클래스로부터 
				상속받아 오버라이딩한 메소드
	 */
	@Override
	...
	/*
	MyClass 형의 객체의 비교를 위해 오버라이딩한 메소드
...
public class E04Object3Equals {
	...
	public static void main(String[] args) {
		...
		/*
		 아래 toString 메소드는 굳이 호출하지 않아도 print문이 
		 실행됭때 자동으로 호출하므로 아래 출력결과는 동일 하다
		 */

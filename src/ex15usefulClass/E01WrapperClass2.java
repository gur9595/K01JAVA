...
public class E01WrapperClass2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("10+strNumber를 숫자로 변경:"+(10+Integer.valueOf(strNumber)));//동일한기능
		
		String momey="120원";
		/*
		 문자열을 숫자로 변경할깨는 반드시 숫자형식만 와야한다
		 "원"은 숫자가 아니므로 NumberFormatException이 발생
		 */
		//System.out.println("120원:"+Integer.parseInt(momey));
		...
		System.out.println("Float실수형으로 변경:"+Float.parseFloat(floatString));
		System.out.println("Double실수형으로 변경:"+Double.parseDouble(floatString));
		
		//Character 주요메소드
		/*
		 2] codePointAt(): 문자열에서 index에 해당하는 한 문자의 아스키코드값을 반환한다.
		 */
		...
		/*
		 6] 대소문자를 판단하는 메소드
		 	:영문자에만 적용되며 알파벳이 아닌경우 false를 반환
		...
		/*
		 시나리오] 주어진 문자열안에 몇개의 공백문자가 있는지 판단하는 프로그램

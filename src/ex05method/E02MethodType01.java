...
public class E02MethodType01 {
	...
	static void noParamNoReturn3() {
		...
		/*
		 위와같이 함수 중간에 return을 쓰게되면 함수가 종효되므로
		 아래 문장은 실행되지 않는 쓰레기 코드가된다
		 따라서 return을 사용할때는 반드시 조건문과 같이 사용하여 한다
		 단 함수의 마지막 부분에 있는경우는 상관없다.
		 */

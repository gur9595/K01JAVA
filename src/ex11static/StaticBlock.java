...
/*
 static블럭
 	:동일 클레스 안의 main메소드보다 먼저 실행되는 블럭으로 
 	main메소드의 실행코드가 없어도 먼저 실행된다
 	단, 다른 클래스에 main이 있는경우 main이 순차적으로 실행되다
 	static블럭이 있는 클래스가 객체화될때 실행되게된다.
 	이떄 생성자보다 static블럭이 먼저 실행된다
 */
public class StaticBlock {
	...
	static {
		 ...
		 */
		//System.out.println("intanceVal="+instanceVar);
		//instanceMethod();

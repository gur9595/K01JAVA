...
/*
 ...
 - 이와같이 내부클래스를 static으로 선언하면Nested클래스하고 한다
 - 정적 멤버변수 & 멤버 메소드를 가질수 있다
 - 외부클래스의 인스터스형 멤버는 사용할수없다
...
class OuterClass{
	...
	void outerMemberMethod() {
		/*
		 외부클래스의 멤버메소드에서는 내부정적클래스의 멤버를 접근할수있다.
	...
	static void outerStaticMethod() {
		/*
		 외부클래스의 정적멤버 메소드에서는 내부클래스의 정적멤버만 접근할수있다.
		 Method영역에서는 Heap영역을 참조할 수 없다.
		 */
		System.out.println("외부클래스의 정적메소드 호출된");
...
public class E02InnerMemberClass {
	public static void main(String[] args) {
		...
		/*
		 ...
		 외부클래스의 멤버변수는 객체생성후 참조변수를 통해 접근한다.
		 */

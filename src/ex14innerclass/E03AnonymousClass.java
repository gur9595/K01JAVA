...
/*
 ...
 형식
 	...
 	부모클래스를 상속박아 이름없는 자식클래스를 생성하는 개녕으로  이해하면된다.
 	상속되기 때문에 오버라이딩이 가능하게된다.
 */
class Person{
	String name;
...
public class E03AnonymousClass {
	public static void main(String[] args) {
		/*
		 Student 라는 이름을 가진 자식클래스를 통해 객체를 생성하고 
		 부모클래스의 참조변수로 참조함
		 참조변수가 부모타입이르로 자식객체에 직접 접근하는것은 불가능
		 반드시 다운캐스팅후 접근해햐한다.
		 */
		...
		/*
		 ...
		 :Person타입의 인스턴스 변수에 Person을 상속받은 익명클래스흫 생성해서 그 주소를 할당
		 개녕적으로 new Person(){}; == >익명 extend Person{};
		 형채라 생각하면 된다
		 이름이 없는 객체이므로 부모클래스의 이름을 빌려서 생성했다고 생각하다
		 */
		...
		/*
		 	부모타입의 참조변수로 하이객체에서 확장한 멤버에 접근할수 없으므로 위부분은 에러발생
		 */
		...
		*/
		...
		AbstractClass ac= new AbstractClass() {
			...
			@Override
			void abstractMethod() {
				System.out.println("추상베소드 오버라이딩");

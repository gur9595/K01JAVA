...
/*
 TreeSet<T> 
 -트리라는 자료구조를 기반으로 한 Set컬랙션이다
 -Set의 기본적인 특성은 동일하나 Tree알고리즘을 통해 정렬되어저장된다
 정령의 기분은 개발자가 직접 정의할 수 있다
 -정렬의 기준을 정하기 위해 Comparable인터페이스를 구현해야한다
 */
class MyString implements Comparable<MyString>{
	...
	/*
	정렬의 기준을 위해 오버라디일한 메소드로
	가나다와 같은 사전순, 문자열의 길이들 다양하게 설정 가능하다.
	아래 코드는 오름차순 (작은것->큰것)정렬일때 사용한다
	1과 -1의 위치가 바뀌면 내림차순한다
	 */
	@Override

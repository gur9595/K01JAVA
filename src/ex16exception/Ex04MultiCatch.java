...
public class Ex04MultiCatch {
	...
	public static void main(String[] args) {
		/*
		 예외처리를 할때 필요에따라 여러개의 catch블럭을 사용할수있다
		 - 이경우 반드시 자식 예외클래스토부터 catch블럭에 사용한다
		 - Exception 클래스는 모든 예외를 catch하기 때문에 마지막 블럭에 사용해햐한다
		 - 중간에 사용하면 에러가 발생한다.
		 */
		...
		try {
			...
			System.out.println("배열의 저장된 두 숫자 나누기:"+ array[0]/array[1]);
			//테스트시 0을 입력할것

...
/*
 ...
 -RunTimeException클래스계열로 NullPointException
 대표적인 하위 클래스이다
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			 ...
			 printStackTrace(): 예외가 발생할때의 에러메세지를
			 	그대로 콜솔에 출력해줌 개발시 훨씬 더 사용빈도가 높음
			 */
		...
		/*
		 4]NullPointerException
		 	...
		 	발생되는예외 즉 참조변수만 생성되고 참조할 객체가 없는 상태에서
		 	사용했을때 발생하게된다.
		 */
		System.out.println("### NullPointerException ###");
		System.out.println("toDat= "+toDay);
		/*
		 toDay 참조변수가 가지고있는 null값을 toString 
		 메소드를 통해 String형태로 변환되어  출력된다 예외는 발생하지않는다
		 */
		try {
			/*

...
/*
 추상클래스2 = 추상메소드를 포함한 클래스
 	추상메소드를 멤버로 포함한 클래스는 반드시 abstract로 정의
 	class앞에 abstract를 지우면 에러
 */
...
/*
 ...
 해당 클래스도 abstract선언하거나 부모의 abstract메소드를 오버라이딩 처리해야함 
 */
...
public class E01AbstractBasic {
	...
	public static void main(String[] args) {
		...
		/*
		 부모타입의 참조변수로 자식객레에 접근하려면 다운캐스팅 후 접근
		 */
		((absClassChild2)absClass2).newMethod();
		
		/*
		 추상클래스내에 선언된 정적멤버는 오버라이딩의 대상이 
		 될수없으므로 static이 가진 기본 규칙을 따른다
		 클래스명으로 접근한다
		 */
